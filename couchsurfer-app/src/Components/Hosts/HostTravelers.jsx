                        ...
                        <div className={styles.main__cont__host__info}>
                            {
                                ...
                                .filter((item)=>{
                                    ...
                                    else if(isAcceptingGuests&&item.accepting_guests===true)
                                    {
                                        return item
                                    }
                                })
                                .filter((item)=>{
                                    ...
                                    else if(whichCity!==""&&item.city.toLowerCase()===whichCity.toLowerCase())
                                    {
                                ...
                                .filter((item)=>{
                                    ...
                                    else if(languageSpoken!==""&&item.language.toLowerCase()===languageSpoken.toLowerCase())
                                    {
