        ...
        <div className="Groups__container__right">
            <div>
              ...
              <div className="Groups__container__right__hr"></div>
                ...
                {data&&data?.map((e)=><> <div onClick={() => handleGroups(e.id)} key={e.id} className="Groups__container__right_image">
                <div >
          ...
          <div style={popUp==false?{display:"none"}:{display:"block"}} className="Groups__addcontainer">
