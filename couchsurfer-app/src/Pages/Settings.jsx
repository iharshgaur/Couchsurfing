...
const Settings = () => {
  React.useEffect(() => {
    document.title = "Settings | Couchsurfers";
  }, []);
      ...
      <div className={styles.AccountSetting}>
        ...
        <div className={styles.settingContainer}>
          <div className={styles.linkAccount}>
            <Link
              className={styles.linkAccount__links}
              style={{ marginTop: 20 }}
            ...
            >{`Emails & Push Notifications`}</Link>
            <Link
              className={styles.linkAccount__links}
              onClick={() => setComponent("membership")}
            >{`Membership & Contributions`}</Link>
            <Link
              className={styles.linkAccount__links}
              onClick={() => setComponent("groups")}
            >
              Groups
            </Link>
            <Link
